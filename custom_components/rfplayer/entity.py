...
from .const import ATTR_EVENT_DATA, CONF_VERBOSE_MODE, SIGNAL_RFPLAYER_AVAILABILITY, SIGNAL_RFPLAYER_EVENT
...
async def async_setup_platform_entry(
    ...
    """Set up config entry."""
    options = RfPlayerOptions.from_json(config_entry.data)
